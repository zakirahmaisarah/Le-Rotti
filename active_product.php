...
<head>
	...
	<title>Le' Rotti - Bread website view active products page</title>
</head>
<body>
	...
	<div class="banner">
		<div class="detail">
			<h1>view active products</h1>
			<p>Indulge in the magic of Le Rotti,<br>where the aroma of freshly baked bread is a prelude to a taste adventure.</p>
			<span><a href="dashboard.php">admin </a><i class="bx bx-right-arrow-alt " ></i> view active products</span>
		</div>
	</div>
	...
	<section class="show_products" style="margin-top: -2rem;">
		...
		<div class="box-container">
			...
			if ($select_active_product->rowCount() > 0) {
				while ($fetch_products = $select_active_product->fetch(PDO::FETCH_ASSOC)) {
